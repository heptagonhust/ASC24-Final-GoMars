...
parser.add_argument('-s', '--suite-xml', dest='suite_xml', default=f'{script_dir}/../suites/suite_FV3_GFS_v17_p8_rrtmgp.xml')
parser.add_argument('-p', '--physics-root', dest='physics_root', default=f'{script_dir}/../physics/physics')
parser.add_argument('-o', '--output-code')
...
refactors = {
	...
	'adjusted_vertical_level_dimension_for_radiation': { 'name': 'nlevp1_rad_adj' },
	'aerosol_asymmetry_parameter_for_shortwave_bands_01_16': { 'name': 'aer_ap_sw_01_16' },
	...
	'aerosol_optical_depth_for_shortwave_bands_01_16': { 'name': 'aer_od_sw_01_16' },
	'aerosol_single_scattering_albedo_for_shortwave_bands_01_16': { 'name': 'aer_ssa_sw_01_16' },
	'atmosphere_optical_thickness_due_to_ambient_aerosol_particles': { 'name': 'aer_od' },
	...
	'cloud_ice_water_path': { 'name': 'cld_iwp' },
	'cloud_liquid_water_mixing_ratio_of_new_state': { 'name': 'qc_new' },
	'cloud_liquid_water_mixing_ratio': { 'name': 'qc' },
	'cloud_liquid_water_path': { 'name': 'cld_lwp' },
	'cloud_overlap_decorrelation_parameter': { 'name': 'cld_overlap_decorr' },
	'cloud_rain_water_path': { 'name': 'cld_rwp' },
	'cloud_snow_water_path': { 'name': 'cld_swp' },
	'cloud_work_function': { 'name': 'cloud_work' },
	'components_of_surface_downward_shortwave_fluxes': { 'name': 'swflxdn_sfc' },
	'control_for_microphysics_scheme': { 'name': 'mp_physics' },
	'control_for_nsstm': { 'name': 'nsstm' },
	'control_for_shortwave_radiation_liquid_clouds': { 'name': 'rad_sw_liq_cld' },
	...
	'date_and_time_at_model_initialization_in_iso_order': { 'name': 'idate' },
	'date_and_time_at_model_initialization_in_united_states_order': { 'skip': True },
	...
	'flag_for_Chikira_Sugiyama_deep_convection': { 'name': 'flag_cs_dcnv' },
	'flag_for_convective_transport_of_tracers': { 'name': 'flag_tracers_conv' },
	...
	'flag_for_lw_clouds_sub_grid_approximation': { 'name': 'flag_lw_cld_sg' },
	...
	'flag_for_sw_clouds_grid_approximation': { 'name': 'flag_sw_cld_sg' },
	...
	'index_of_hail_mixing_ratio_in_tracer_concentration_array': { 'name': 'idx_qh' },
	...
	'index_of_mass_number_concentration_of_hail_in_tracer_concentration_array': { 'name': 'idx_nh' },
	'index_of_mass_number_concentration_of_hygroscopic_aerosols_in_tracer_concentration_array': { 'name': 'idx_naer' },
	'index_of_mass_number_concentration_of_nonhygroscopic_ice_nucleating_aerosols_in_tracer_concentration_array': { 'name': 'idx_niaer' },
	'index_of_mass_number_concentration_of_rain_in_tracer_concentration_array': { 'name': 'idx_nr' },
	'index_of_mass_number_concentration_of_snow_in_tracer_concentration_array': { 'name': 'idx_ns' },
	'index_of_ozone_mixing_ratio_in_tracer_concentration_array': { 'name': 'idx_qo3' },
	'index_of_rain_mixing_ratio_in_tracer_concentration_array': { 'name': 'idx_qr' },
	'index_of_snow_mixing_ratio_in_tracer_concentration_array': { 'name': 'idx_qs' },
	'index_of_specific_humidity_in_tracer_concentration_array': { 'name': 'idx_qv' }, # FIXME: Why is not dry mixing ratio?
	'index_of_timestep': { 'name': 'time_step' },
	'index_of_turbulent_kinetic_energy_in_tracer_concentration_array': { 'name': 'idx_tke' },
	...
	'latitude': { 'name': 'lat' },
	'layer_pressure_thickness_for_radiation': { 'name': 'dp_rad' },
	'layer_thickness_for_radiation': { 'name': 'dz_rad' },
	'level_of_dividing_streamline': { 'name': 'rdxzb' },
	'longitude': { 'name': 'lon' },
	'lower_bound_of_vertical_dimension_of_surface_snow': { 'name': 'sfc_snow_kms' },
	...
	'mean_effective_radius_for_ice_cloud': { 'name': 'cld_reff_ice' },
	'mean_effective_radius_for_liquid_cloud': { 'name': 'cld_reff_liq' },
	'mean_effective_radius_for_rain_drop': { 'name': 'rain_reff' },
	'mean_effective_radius_for_snow_flake': { 'name': 'snow_reff' },
	...
	'mpi_communicator': { 'name': 'mpi_comm' },
	...
	'number_of_tracers_for_convective_transport': { 'name': 'ntracers_conv' },
	...
	'ozone_forcing': { 'name': 'ozone_forcing' },
	...
	'random_number_seed_for_mcica_longwave': { 'name': 'seed_mcica_lw' },
	'random_number_seed_for_mcica_shortwave': { 'name': 'seed_mcica_sw' },
	...
	'stratospheric_water_vapor_forcing': { 'name': 'strat_vapor_forcing' },
	...
	'surface_albedo_due_to_near_IR_diffused': { 'name': 'alb_dif_nir' },
	'surface_albedo_due_to_near_IR_direct': { 'name': 'alb_dir_nir' },
	'surface_albedo_due_to_UV_and_VIS_diffused': { 'name': 'alb_dif_uv_vis' },
	'surface_albedo_due_to_UV_and_VIS_direct': { 'name': 'alb_dir_uv_vis' },
	...
	'surface_downwelling_diffuse_near_infrared_shortwave_flux': { 'name': 'swflxdn_sfc_dif_nir' },
	'surface_downwelling_diffuse_nir_shortwave_flux_on_radiation_timestep': { 'name': 'swflxdn_sfc_dif_nir_rad'},
	'surface_downwelling_diffuse_ultraviolet_and_visible_shortwave_flux': { 'name': 'swflxdn_sfc_dif_uvvis' },
	'surface_downwelling_diffuse_uv_and_vis_shortwave_flux_on_radiation_timestep': { 'name': 'swflxdn_sfc_dif_uvvis_rad' },
	'surface_downwelling_direct_near_infrared_shortwave_flux': { 'name': 'swflxdn_sfc_dir_nir' },
	'surface_downwelling_direct_nir_shortwave_flux_on_radiation_timestep': { 'name': 'swflxdn_sfc_dir_nir_rad' },
	'surface_downwelling_direct_ultraviolet_and_visible_shortwave_flux': { 'name': 'swflxdn_sfc_dir_uvvis' },
	'surface_downwelling_direct_uv_and_vis_shortwave_flux_on_radiation_timestep': { 'name': 'swflxdn_sfc_dir_uvvis_rad' },
	...
	'surface_drag_coefficient_for_heat_and_moisture_in_air': { 'name': 'ch' },
	...
	'surface_drag_coefficient_for_momentum_in_air': { 'name': 'cm' },
	...
	'surface_upwelling_diffuse_near_infrared_shortwave_flux': { 'name': 'swflxup_sfc_dif_nir' },
	'surface_upwelling_diffuse_nir_shortwave_flux_on_radiation_timestep': { 'name': 'swflxup_sfc_dif_nir_rad' },
	'surface_upwelling_diffuse_ultraviolet_and_visible_shortwave_flux': { 'name': 'swflxup_sfc_dif_uvvis' },
	'surface_upwelling_diffuse_uv_and_vis_shortwave_flux_on_radiation_timestep': { 'name': 'swflxup_sfc_dif_uvvis_rad' },
	'surface_upwelling_direct_near_infrared_shortwave_flux': { 'name': 'swflxup_sfc_dir_nir' },
	'surface_upwelling_direct_nir_shortwave_flux_on_radiation_timestep': { 'name': 'swflxup_sfc_dir_nir_rad' },
	'surface_upwelling_direct_ultraviolet_and_visible_shortwave_flux': { 'name': 'swflxup_sfc_dir_uvvis' },
	'surface_upwelling_direct_uv_and_vis_shortwave_flux_on_radiation_timestep': { 'name': 'swflxup_sfc_dir_uvvis_rad' },
	'surface_upwelling_longwave_flux_over_land': { 'name': 'lwflxup_sfc_lnd' },
	'surface_upwelling_longwave_flux_over_ice': { 'name': 'lwflxup_sfc_ice' },
	...
	'tendency_of_air_temperature_due_to_shortwave_heating_assuming_clear_sky_on_radiation_time_step_and_radiation_levels': { 'name': 'dtdt_sw_clr_rad_lev' },
	'tendency_of_air_temperature_due_to_shortwave_heating_assuming_clear_sky_on_radiation_timestep': { 'name': 'dtdt_rad_sw_clr' },
	'tendency_of_air_temperature_due_to_shortwave_heating_on_radiation_time_step_and_radiation_levels': { 'name': 'dtdt_sw_rad_lev' },
	...
	'total_cloud_fraction': { 'name': 'cldfrac_tot' },
	...
	for group in suite:
		...
		for subcycle in group:
			for scheme in subcycle:
				...
				meta_file = f'{physics_root}/{scheme.text.strip()}.meta'
				if not os.path.isfile(meta_file):
					meta_file = f'{physics_root}/{scheme.text.strip()}.fv3.meta'
				if not os.path.isfile(meta_file):
					meta_file = f'{physics_root}/{meta_rename[scheme.text.strip()]}.meta'
				if not os.path.isfile(meta_file):
					print(f'[Error]: Failed to find {meta_file}!')
					exit(1)
...
{var_statements}
  contains
    procedure :: init => gmcore_ccpp_init
    procedure :: clear => gmcore_ccpp_clear
    procedure :: rad_reset => gmcore_ccpp_rad_reset
    procedure :: phys_reset => gmcore_ccpp_phys_reset
  end type gmcore_ccpp_type

contains

  subroutine gmcore_ccpp_init(this)

    class(gmcore_ccpp_type), intent(inout) :: this
    
  end subroutine gmcore_ccpp_init

  subroutine gmcore_ccpp_clear(this)

    class(gmcore_ccpp_type), intent(inout) :: this
    
  end subroutine gmcore_ccpp_clear

  subroutine gmcore_ccpp_rad_reset(this)

    class(gmcore_ccpp_type), intent(inout) :: this
    
  end subroutine gmcore_ccpp_rad_reset

  subroutine gmcore_ccpp_phys_reset(this)

    class(gmcore_ccpp_type), intent(inout) :: this
    
  end subroutine gmcore_ccpp_phys_reset

end module gmcore_typedefs_mod'''
	return code

code = gen_code(var_list)
if args.output_code != None:
