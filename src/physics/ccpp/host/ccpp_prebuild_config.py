...
# CCPP prebuild config for IAP LASG GMCORE
...
VARIABLE_DEFINITION_FILES = [
    ...
    'host/CCPP_typedefs.F90',
    'host/GFS_typedefs.F90',
    'host/CCPP_data.F90',
    ]
...
STATIC_API_CMAKEFILE = '{build_dir}/CCPP_STATIC_API.cmake'
STATIC_API_SOURCEFILE = '{build_dir}/CCPP_STATIC_API.sh'
...
HTML_VARTABLE_FILE = '{build_dir}/CCPP_VARIABLES_GMCORE.html'

# LaTeX document containing the provided vs requested CCPP variables
LATEX_VARTABLE_FILE = '{build_dir}/CCPP_VARIABLES_GMCORE.tex'
