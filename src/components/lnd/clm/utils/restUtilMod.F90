...
# 26 "restUtilMod.F90.in"
  interface restartvar
     ...
     ! dimension, call restartvar_2d_text_bounds.
     ! dimension, call restartvar_2d_real_bounds.
     ! dimension, call restartvar_2d_double_bounds.
     ! dimension, call restartvar_2d_int_bounds.
     ! dimension, call restartvar_2d_short_bounds.
...
# 97 "restUtilMod.F90.in"
contains

  !-----------------------------------------------------------------------
  !DIMS 0
  !TYPE text,int,double
# 102 "restUtilMod.F90.in"
...
# 590 "restUtilMod.F90.in"
  end subroutine set_missing_from_template

  !-----------------------------------------------------------------------
# 593 "restUtilMod.F90.in"
  subroutine set_grc_field_from_col_field(bounds, ncid, varname, data_grc, readvar)
    ...
    deallocate(data_col)
# 639 "restUtilMod.F90.in"
  end subroutine set_grc_field_from_col_field

  !-----------------------------------------------------------------------
  ! DIMS 1,2
# 643 "restUtilMod.F90.in"
...
# 704 "restUtilMod.F90.in"
  end subroutine missing_field_possibly_abort

  !-----------------------------------------------------------------------
# 707 "restUtilMod.F90.in"
