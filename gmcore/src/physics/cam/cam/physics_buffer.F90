...
!===============================================================================
# 174 "physics_buffer.F90.in"
CONTAINS
!===============================================================================

# 177 "physics_buffer.F90.in"
...
#endif
    return
# 391 "physics_buffer.F90.in"
  end subroutine pbuf_initialize


# 394 "physics_buffer.F90.in"
...
# 456 "physics_buffer.F90.in"
  end subroutine pbuf_allocate

  ! TYPE int,double,real
# 459 "physics_buffer.F90.in"
...
# 746 "physics_buffer.F90.in"
  end subroutine pbuf_register_subcol

# 748 "physics_buffer.F90.in"
...
# 754 "physics_buffer.F90.in"
  end subroutine pbuf2d_print

# 756 "physics_buffer.F90.in"
...
# 1548 "physics_buffer.F90.in"
  end subroutine pbuf_read_restart

  ! TYPE int,double,real
# 1551 "physics_buffer.F90.in"
...
# 1738 "physics_buffer.F90.in"
  end subroutine pbuf_dump_pbuf

# 1740 "physics_buffer.F90.in"
...
!--------------------------------------------------------
   ...
   integer                            :: i, j
   integer                            :: dim_size
   character(len=max_hcoordname_len)  :: dim_name
   character(len=max_hcoordname_len)  :: dim_string
...
# 1770 "physics_buffer.F90.in"
end subroutine pbuf_cam_snapshot_register

# 1772 "physics_buffer.F90.in"
